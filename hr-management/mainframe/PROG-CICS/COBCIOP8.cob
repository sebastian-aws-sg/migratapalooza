      *-----------------------------------------------------------------
      *    COBCIOP8 - SAMPLE COBOL-CICS PROGRAM TO DISPLAY ALL THE 
      *               EMPLOYEES HAVING SALARY EQUAL TO THE AMOUNT OR 
      *               IS IN THE RANGE OF ENTERED PERCENTAGE ENTERED BY 
      *               USER ON CICS SCREEN.
      *
      *               USER ENTERS SALARY FROM THE SCREEN AND 
      *               COBOL-CICS PROGRAM CALLS COBOL PROGRAM TO GET 
      *               EMPLOYEE NAMES, NUMBERS AND SALARIES OF TOP 10 EMPLOYEES 
      *               HAVING SALARY IN THE SPECIFIED RANGE OF THE INPUT SALARY. 
      *               IF USER ENTERS 0 AS THE VARIATION PERCENTAGE, PROGRAM WILL
      *               LOOK FOR ONLY THOSE EMPLOYEE HAVING SALARY EXACTLY EQUAL 
      *               TO WHAT THE USER HAS ENTERED.
      *               VARIATION IS CALCULATED ON THE AMOUNT ENTERED BY THE 
      *               USER.
      *-----------------------------------------------------------------
      *                                                                 
      ...
      *    TARGET OF EIBDATE ASSIGNMENT MUST BE PIC 9(7) COMP-3.        
       ...
       01  COMMAREA                                                     
           ...
           03  CASTMSALVARI         PIC S9(3)      USAGE COMP-3.                                   
       ...
       01  WS-WORKING-VARS.                                                 
               ...
               02  WS-SALVAR               PIC S9(3) USAGE COMP-3.                                                                        
      ...
      *    **  validate employee salary variation                            
                                                                        
           IF  CASTMSALVL IS SPACES THEN                                    
               MOVE -1             TO  CASTMSALVL                        
               MOVE 6              TO  WORK-MSG-CODE                    
               GO TO 300-SEND-MAP                                       
           ELSE                                                         
               IF CASTMSALVL IS NOT NUMERIC THEN                         
                  MOVE -1             TO  CASTMSALVL                     
                  MOVE 14             TO  WORK-MSG-CODE                 
                  GO TO 300-SEND-MAP                                    
               END-IF                                                   
      ...
      *-----------------------------------------------------------------                                                                  
       400-READ-EMP-RECORD.                                             
           ...
           MOVE CASTMSALVARI  TO CASTMSALVI.                                   
           CALL "COBSALR2"    USING COMMAREA.                              
