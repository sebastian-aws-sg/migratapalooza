      *-----------------------------------------------------------------
      *    COBCIOP2 - SAMPLE CICS PROGRAM TO GET THE DETAILS OF AN      
      *               EMPLOYEE BY CALLING ANOTHER COBOL PROGRAM. THE    
      *               EMPLOYEE INFORMATION MIGHT BE REQUESTED BY ANY    
      *               EXTERNAL PROGRAM. IN THIS CASE, THE EXTERNAL J2EE.
