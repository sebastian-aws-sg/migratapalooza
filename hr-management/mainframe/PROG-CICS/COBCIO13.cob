      *-----------------------------------------------------------------
      *    COBCIOP13 - DUMMY PROGRAM TO ACCESS PROJECT ACTIVITY DETAILS 
      *                AND STORE IN THE MESSAGE QUEUE WHICH CAN BE ACCESSED BY 
      *               THE JAVA PROGRAM FROM MESSAGE QUEUE USING JCICS 
      *               CONNECTOR AND JAVA TO CICS GATEWAY.
      *-----------------------------------------------------------------
      *                                                                 
