      *-----------------------------------------------------------------
      *    COBCIOP9 - SAMPLE COBOL-CICS PROGRAM TO DISPLAY ALL THE 
      *               EMPLOYEES HAVING SALARY LESS THAN OR EQUAL TO 
      *               THE USER INPUT ON CICS SCREEN.
      *
      ...
      *               HAVING SALARY LESS THAN OR EQUAL TO INPUT SALARY. 
      *-----------------------------------------------------------------
      *                                                                 
