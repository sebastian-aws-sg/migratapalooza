       ...
       01  WRK-DATE-MMXDDXYY              PIC X(08).
       01  WRK-DATE                       PIC X(05) VALUE SPACES.
       01  WRK-DATE-YYDDD                 PIC X(05) VALUE SPACES.
       01  WRK-DATE-YYXDDXMM              PIC X(08) VALUE SPACES.
       01  WRK-DATE-DDD                   PIC X(03) VALUE SPACES.
       01  WRK-YEAR-YY                    PIC X(02) VALUE SPACES.
       01  WRK-MTH-DAYS OCCURS 31         PIC X(02).
       01  WRK-LEAP                       PIC 9(03).
       01  WRK-YEAR-YYYY-NUM              PIC 9(04) VALUE 0.
       01  WRK-DTE-MM-NUM                 PIC 9(02) VALUE 0.
       01  WRK-DTE-DD                     PIC X(02) VALUE SPACES.
       01  WRK-DTE-MM                     PIC X(02) VALUE SPACES.
       01  WRK-DTE-YY                     PIC X(02) VALUE SPACES.
