...
var dlrStsCd    = '<bean:write name="TemplateForm" property="transaction.dlrStCd" />';
var cltStsCd	= '<bean:write name="TemplateForm" property="transaction.cltStCd" />';
isDealer	= '<bean:write name ="TemplateForm" property="actingDealer" />';
var buttonsPrsnt = "true";
...
<tr>
<td class="menuItem" style="display:none;" id="postAmend"><img id="postAmend" src="/mcx/static/images/post_comm_his_icon.gif" alt="Post Amendment" /> Post Amendment</td>
</tr>
<tr>
<td class="menuItem" style="display:none;" id="postComnt"><img id="postComnt" src="/mcx/static/images/post_comm_his_icon.gif" alt="Post Comment/View History" /> Post Comment/View History</td>
</tr>
<tr>
...
<tr>
<td class="menuItem" style="display:none;" id="agreeAmend" ><img id="agreeAmend" src="/mcx/static/images/agree_amend_icon.gif" alt="Agree to Amendment" /> Agree to Amendment</td>
</tr>
<tr>
...
<html:hidden property="frmScr" value="NEG"/>
<html:hidden property="transaction.tmpltNm" />
<html:hidden property="transaction.tmpltTyp" />
<html:hidden property="tmpltId" />
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	  <tr>
		<td height="10"><img src="/mcx/static/images/spacer.gif" /></td>
			...
			<tr>
			       			 <td colspan="9" class="con1 padL20a"><bean:write name="TemplateForm" property="transaction.ISDATmpltNm" /></td>
			      		</tr>
				          <tr>
							<td colspan="2" height="10"><img src="/mcx/static/images/spacer.gif" /></td>
      		</tr>
							  ...
							  <table>
								<tr>
									...
									<logic:equal name="TemplateForm" property="transaction.lockUsrInd" value="L">
										<td width="12%"  colspan="2" align="right">
											<input class="enroll_red" 	type="button" name="Submit_unlock" 	value="UNLOCK" 	onclick="unlock_mca('<bean:write name ="TemplateForm" property="transaction.tempValAvl" />', true,'<bean:write name="TemplateForm" property="transaction.tmpltNm" />')" id="back" />
											<img border="0" src="/mcx/static/images/lock.gif" alt="This document is locked by  <bean:write name="TemplateForm" property="transaction.lockByUsrNm"/>"/>
										</td>
									</logic:equal>
									<logic:equal name="TemplateForm" property="transaction.lockUsrInd" value="O">
										<td width="12%"  colspan="2" align="right">		
											<input class="enroll_red" disabled type="button" name="Submit_unlock" value="UNLOCK" id="back" />
											<img border="0" src="/mcx/static/images/unlock.gif" alt="This document is locked by  <bean:write name="TemplateForm" property="transaction.lockByUsrNm"/>"/>
										</td>
									</logic:equal>
									<logic:equal name="TemplateForm" property="transaction.lockUsrInd" value="D">
										<td width="12%"  colspan="2" align="right">		
										</td>
									</logic:equal>
									</logic:equal>
											  ...
											  <logic:equal name="termBean" property="termStCd" value="Y">										  										 
												...
												<logic:equal name="termBean" property="termStCd" value="Y">
													<logic:equal name="termBean" property="amndtStCd" value="P">
														<td colspan="10" width="79%"  valign="top" class="red border5_bluemca" oncontextmenu="if (!event.ctrlKey){displayMenu_negotiate('<bean:write name="termBean" property="termValId" />','<bean:write name="termBean" property="amndtStCd" />','<bean:write name="termBean" property="cmntInd" />','<bean:write name="categoryBean" property="catgyStCd"/>');return false;}">
													...
													<logic:equal name="termBean" property="amndtStCd" value="A">
														<td colspan="10" width="79%"  valign="top" class="green border5_bluemca" oncontextmenu="if (!event.ctrlKey){displayMenu_negotiate('<bean:write name="termBean" property="termValId" />','<bean:write name="termBean" property="amndtStCd" />','<bean:write name="termBean" property="cmntInd" />','<bean:write name="categoryBean" property="catgyStCd"/>');return false;}">
														<bean:write name="termBean" property="termVal" filter="false" />
														<logic:equal name="termBean" property="cmntInd" value="true">
															<img src="/mcx/static/images/note_icon.gif"/>
														</logic:equal>&nbsp;
													...
													<logic:equal name="termBean" property="amndtStCd" value="I">
														<td colspan="10" width="79%"  valign="top" class="normal border5_bluemca" oncontextmenu="if (!event.ctrlKey){displayMenu_negotiate('<bean:write name="termBean" property="termValId" />','<bean:write name="termBean" property="amndtStCd" />','<bean:write name="termBean" property="cmntInd" />');return false;}">
														<bean:write name="termBean" property="termVal" filter="false" />
														<logic:equal name="termBean" property="cmntInd" value="true">
															<img src="/mcx/static/images/note_icon.gif"/>
														</logic:equal>&nbsp;
												...
												<td colspan="10" width="79%"  valign="top" class="normal border5_bluemca">
												<bean:write name="termBean" property="termNm"/>&nbsp;
												</td>					
												</logic:equal>
											  </tr>	    
  ...
  <tr align="right">
    <td>
    	<logic:notEqual name="TemplateForm" property="transaction.tmpltTyp" value="E" >
	    	<logic:equal name="TemplateForm" property="transaction.tempValAvl" value="true" >
				<derivserv:access privilege="Modify">
			    	<input class="long" type="button" name="Save" value="SAVE CHANGES" onclick="saveTemplate('<bean:write name="TemplateForm" property="transaction.tmpltNm" />')" />
			    </derivserv:access>
			</logic:equal>
	    	<logic:notEqual name="TemplateForm" property="transaction.tempValAvl" value="true" >
				<derivserv:access privilege="Modify">
			    <input class="long_greyed_disabled" type="button" name="Save" value="SAVE CHANGES" />
				</derivserv:access>
			</logic:notEqual>
			<logic:equal name="TemplateForm" property="enableSubmitToCP" value="true" >
				<derivserv:access privilege="Modify">
		    	<input class="long_sendback_coun" type="button" name="SubmitToCP" onclick="submitToCP()" value="SUBMIT TO COUNTERPARTY" />
			    </derivserv:access>
		    </logic:equal>
			<logic:notEqual name="TemplateForm" property="enableSubmitToCP" value="true" >
				<derivserv:access privilege="Modify">
		    	<input class="long_greyed_disabled_coun" type="button" name="SubmitToCP" value="SUBMIT TO COUNTERPARTY" />
			    </derivserv:access>
		    </logic:notEqual>
		    <logic:equal name="TemplateForm" property="enableExecute" value="true" >
				<derivserv:access privilege="Modify">
			   		 <input class="long_sendback_coun" type="button" name="Execute" onclick="executeMCA('<bean:write name ="TemplateForm" property="actingDealer" />')" value="EXECUTE MCA" />
			   	</derivserv:access>
		   	</logic:equal>
		    <logic:notEqual name="TemplateForm" property="enableExecute" value="true" >
				<derivserv:access privilege="Modify">
		   		 <input class="long_greyed_disabled_coun" type="button" name="Execute" value="EXECUTE MCA" />
			   	</derivserv:access>
		   	</logic:notEqual>
	    </logic:notEqual>
	    
	    <logic:equal name="TemplateForm" property="transaction.tmpltTyp" value="E">
	    <logic:equal name ="TemplateForm" property="actingDealer" value="true" >
	    	<logic:equal name="TemplateForm" property="transaction.eligibleForReNeg" value="true">
				<derivserv:access privilege="Modify">
	    <input class="long" type="button" name="ReExecute" value="RE-NEGOTIATE" onclick="renegotiateMCA('<bean:write name="TemplateForm" property="transaction.tmpltNm" />','<bean:write name="TemplateForm" property="transaction.orgDlrCd" />','<bean:write name="TemplateForm" property="transaction.orgCltCd" />')" />
				</derivserv:access>
	    </logic:equal>

	    	<logic:notEqual name="TemplateForm" property="transaction.eligibleForReNeg" value="true">
				<derivserv:access privilege="Modify">
				    <input class="long_greyed_disabled" type="button" name="ReExecute" value="RE-NEGOTIATE" />
				</derivserv:access>
				</logic:notEqual>
	    </logic:equal>
	    <logic:equal name ="TemplateForm" property="actingDealer" value="false" >
	    	<script>buttonsPrsnt = "false"; </script>
	    </logic:equal>
	    </logic:equal>
    </td>
  </tr>
...
<script>
if(buttonsPrsnt == "true" && !hasModify)
	updateButtonValues();
