...
document.getElementById("termcommentframe").src = "/mcx/action/view_comment?tmpltID="+tmpltID+"&termValId="+termValueId+"&tmpltType="+tmpltType+"&tmpltLocked="+lockSt+"&ISDATmpltNm="+ISDATmpltNm+"&lockUsrInd="+lockUsrInd+"&userInd=D&frmScr="+fromScreen+"&userCompany="+displayNm+"&actingDealer="+isDealer+"&random="+randomnumber;
}
</script>
<form>
<iframe id="termcommentframe" src="javascript:'';"
