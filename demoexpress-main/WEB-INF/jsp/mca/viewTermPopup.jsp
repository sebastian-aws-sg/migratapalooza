...
document.getElementById("viewTerm").src = "/mcx/action/viewISDATerm?termValId="+termValueId+"&tmpltType="+tmpltType+"&tmpltLocked="+lockSt+"&ISDATmpltNm="+ISDATmpltNm+"&random="+randomnumber;
}
</script>
<form>
<iframe id="viewTerm" src="javascript:'';"
