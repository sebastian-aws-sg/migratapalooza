		...
		<table width="94%" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				...
				<table width="800" height="153" class="border" cellpadding="0"
					...
					<tr>
						<td width="100%" height="26px" class="product_bg1 border4a1"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="alert.subject"/>:&nbsp;&nbsp;</b><c:out value="${alertinfo.subject}"/><br /><b>&nbsp;&nbsp;<bean:message key="alert.receivedon"/>:&nbsp;&nbsp;</b><c:out value="${alertinfo.updatetimestamp}"/></td>
					</tr>
					<tr>
...
<tr>
	...
	<tr>
	    <td  colspan="3" class="padL20a"><input class="save" type="submit"
