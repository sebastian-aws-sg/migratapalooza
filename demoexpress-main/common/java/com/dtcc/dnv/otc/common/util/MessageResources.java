 ...
 * @version 1.0
 * 
 * This class provide access to ApplicationResources class for
 * all the component living outside of "Struts" world
 */
public class MessageResources 
{
    private static String APPLICATION_RESOURCES      = "com.dtcc.dnv.otc.resources.ApplicationResources";
