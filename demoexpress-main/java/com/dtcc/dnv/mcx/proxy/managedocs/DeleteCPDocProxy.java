...
import com.dtcc.dnv.mcx.db.managedocs.DPMXDDDCDAO;
 ...
 *  
 */
public class DeleteCPDocProxy extends AbstractDbProxy
{
    private final static MessageLogger log = MessageLogger.getMessageLogger(DeleteCPDocProxy.class.getName());
    ...
    {
        log.info("In DeleteCPDocProxy to fetch list of dealers");
        DealerClientListDbResponse dbResponse = new DealerClientListDbResponse();
        DPMXDDDCDAO dao = new DPMXDDDCDAO();
        dao.callSP(dbRequest,dbResponse);
        log.info("Returning from DeleteCPDocProxy");
        return dbResponse;
    }
}
