package com.dtcc.dnv.mcx.proxy.user;

import com.dtcc.dnv.mcx.db.user.DPMXHUSRDAO;
...
public final class UserGUIDDbProxy extends AbstractDbProxy {
	...
	public IDbResponse processRequest(IDbRequest dbRequest) throws DBException, ClassCastException {
		...
		UserGUIDDbResponse dbResponse = new UserGUIDDbResponse();
		DPMXHUSRDAO  db = new DPMXHUSRDAO();
