...
import com.dtcc.dnv.mcx.db.enroll.DPMXESELDAO;
...
/**
 * This class is used as a proxy to retrive List of MCA between two couterparties
 * 
 ...
 *  
 */
public class SelectMCAProxy extends AbstractDbProxy
{
    ...
    {
        SelectMCADbResponse dbResponse = new SelectMCADbResponse();

        DPMXESELDAO dao = new DPMXESELDAO();
