...
import com.dtcc.dnv.mcx.db.alert.DPMXAADLDAO;
 ...
 * @version 1.0
 * 
 * This class is used as proxy to DAO for getting alert detail
 *  
 */
public class ViewAlertDetailProxy extends AbstractDbProxy {
	/* (non-Javadoc)
	...
	public IDbResponse processRequest(IDbRequest request) throws DBException{
		...
		DPMXAADLDAO db = new DPMXAADLDAO();
