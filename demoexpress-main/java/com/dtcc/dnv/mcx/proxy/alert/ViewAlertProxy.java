...
import com.dtcc.dnv.mcx.db.alert.DPMXAVALDAO;
 ...
 * @version 1.0
 * 
 * This class is used as proxy to DAO for getting alert list
 *  
 */
public class ViewAlertProxy extends AbstractDbProxy {
	/* (non-Javadoc)
	...
	public IDbResponse processRequest(IDbRequest request) throws DBException{
		...
		DPMXAVALDAO db = new DPMXAVALDAO();
