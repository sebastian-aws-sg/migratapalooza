...
import com.dtcc.dnv.mcx.db.mca.DPMXMCGYDAO;
...
public  class CategoryListProxy extends AbstractDbProxy {
	/**
	...
	public IDbResponse processRequest(IDbRequest dbRequest) throws DBException
	{
		...
		CategoryDbResponse dbResponse = new CategoryDbResponse();				
		DPMXMCGYDAO dao = new DPMXMCGYDAO();        
