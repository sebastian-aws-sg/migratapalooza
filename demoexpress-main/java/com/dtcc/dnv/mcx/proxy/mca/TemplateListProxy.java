...
import com.dtcc.dnv.mcx.db.mca.DPMXMALLDAO;
...
/**
 * This class is used as a proxy to retrive the List of Templates associated with a
 * Product, Sub-Product, Region
 * 
...
public class TemplateListProxy extends AbstractDbProxy {
	/**
	...
	public IDbResponse processRequest(IDbRequest dbRequest) throws DBException
	{
		...
		DPMXMALLDAO dao = new DPMXMALLDAO();        
