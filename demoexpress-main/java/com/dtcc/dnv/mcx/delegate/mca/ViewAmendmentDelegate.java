 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ViewAmendmentDelegate extends MCXAbstractBusinessDelegate {
	
	private final static MessageLogger log = MessageLogger.getMessageLogger(ViewAmendmentDelegate.class.getName());
	...
	public IServiceResponse processRequest(IServiceRequest request)
		...
		{
			throw new BusinessException("BE03", "Unable to lock template");
		}
