package com.dtcc.dnv.mcx.dbhelper.user;
...
public final class UserGUIDDbRequest extends MCXAbstractDbRequest {
	...
	public UserGUIDDbRequest ( String requestId, AuditInfo auditInfo) {
