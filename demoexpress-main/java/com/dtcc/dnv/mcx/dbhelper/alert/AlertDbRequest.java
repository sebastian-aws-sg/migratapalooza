 ...
 * @version 1.0
 * 
 * This class is used as db helper to alert request.
 *  
 */
public class AlertDbRequest extends MCXAbstractDbRequest
{
    /**
     * @param requestId
     * @param auditInfo
     */
    public AlertDbRequest(String requestId, AuditInfo auditInfo)
    {
