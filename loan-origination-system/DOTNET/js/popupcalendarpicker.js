...
function popUpCalendar(ctl,	imagePath, ctl2, format) {
    
    // save image path and adjust close button image which is already rendered
    imgDir = imagePath	    
    document.getElementById("closeimage").src = imagePath + 'close.gif'
    ...
    {
        init()
        popUpCalendar(ctl, imagePath, ctl2, format)
    }
}
