...
<title>Recipe Comment Manager</title>
    <link href="../CSS/cssreciaspx.css" rel="stylesheet" type="text/css" />
<script type="text/javascript">
function SelectAll()
{
      var ChkAll = document.getElementById('RecipeComments_ctl01_chkAll');     
      var IsChecked = ChkAll.checked;
      var Chk = ChkAll;

      Parent = document.getElementById('RecipeComments');          
...
<input type="hidden" id="inputCsvID" name="inputCsvID" runat="server" />
<input type="hidden" id="inputCsvItemID" name="inputCsvItemID" runat="server" />
...
<fieldset><legend style="font-size:11px">Top 25 Users Who Comment</legend>
    <asp:Repeater id="Top25UsersWhoCommentARecipe" runat="server">
        <ItemTemplate>
            <div class="dcnt2" style="margin-top: 2px;">
             <img src="../images/user-icon.gif" />&nbsp;<a href="commentsmanager.aspx?find=<%# Eval("Author")%>" onmouseover="Tip('<b><%# Eval("Author")%></b> wrote (<%# Eval("TotalComments")%>) comments.<br>Click to view all comments by <b><%# Eval("Author")%></b>', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()" class="content2"><%# Eval("Author")%></a>&nbsp;<span class="content2">(<%# Eval("TotalComments")%>)</span>
            </div>         
       </ItemTemplate>
  </asp:Repeater>
    </fieldset>
...
<table width="100%" border="0" cellspacing="1">
  <tr>
    <th scope="row"><div align="left">
     <asp:GridView runat="server" id="RecipeComments" cssclass="content2" AutoGenerateColumns="False" 
     Backcolor="#ffffff" BorderStyle="none" BorderColor="#E1EDFF" cellpadding="5" Width="95%" HorizontalAlign="Center" PageSize="50" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="NewPage" OnSorting="RecipeComments_Sorting" OnRowDataBound="RecipeComments_RowDataBound" DataKeyNames="COM_ID" OnRowCommand="RecipeComments_RowCommand"> 
